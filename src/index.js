                ...
                <div class="container">
                  ...
                  <div class="container"> 
                      ...
                      <div class="col-lg-12 col-12">     
                        <p class="lead text-capatilize text-center"><b>Additionally, we build software using: ES6, passport.js,Redux, Express, Typescript,php,Bootstrap 4,material-design,CMS,WORDPRESS,json,RestApi, Gitlab,Firebase,My-SQL</b></p>
                        </div>
                    </div>
                    </div>
                    <br/>
